...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.service-card, .service-detail-card, .feature, .process-step, .faq-item, .contact-item');
...
function createBackToTopButton() {
    ...
    backToTop.addEventListener('mouseenter', () => {
        ...
        backToTop.style.boxShadow = '0 8px 25px rgba(0, 123, 255, 0.4)';
    });
...
// Add CSS for focused form elements
